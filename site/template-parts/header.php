  ...
  <div class="fixed-scroll-bar" id="fixedOnScrollMenu">
    ...
    <div class="container-fluid nav-container" id="navContainer">
      <div class="row nav-row">
        ...
        <a href="/" id="navLogo" class="sm-logo">
          <?= file_get_contents(ABSPATH . '/img/logo-sm.svg'); ?>
        </a>
        <nav class="col top-nav" id="topNavCol">
          <ul class="top-menu" id="topMenu">
            ...
            if ($login) {
            ?>
              <li class="nav-item mobile mobile-profile-menu user-top">
                <div class="user-heading">
                  <div class="avatar">
                    <img src="http://beautyhack.n.vnetby.net/img/authors/list_01.jpg" alt="avatar">
                  </div>
                  <a href="#" data-toggle="collapse" data-target="#mobileProfileMenu" class="user-name">София Воробьева</a>
                </div>
                <div class="collapse-wrap collapse" id="mobileProfileMenu">
                  <ul class="profile-menu">
                    <li class="profile-menu-item set-item">
                      <a href="#" class="profile-menu-link grey2 hover-black">
                        <span class="ico">
                          <svg width="24" height="24" viewBox="0 0 24 24">
                            <rect class="svg-stroke" x="4.5" y="2.5" width="1" height="19" stroke="black"></rect>
                            <rect class="svg-stroke" x="2.75" y="6.75" width="4.5" height="4.5" fill="white" stroke="black" stroke-width="1.5"></rect>
                            <rect class="svg-stroke" x="18.5" y="2.5" width="1" height="19" stroke="black"></rect>
                            <rect class="svg-stroke" x="16.75" y="6.75" width="4.5" height="4.5" fill="white" stroke="black" stroke-width="1.5"></rect>
                            <rect class="svg-stroke" x="11.5" y="2.5" width="1" height="19" stroke="black"></rect>
                            <rect class="svg-stroke" x="9.75" y="12.75" width="4.5" height="4.5" fill="white" stroke="black" stroke-width="1.5"></rect>
                          </svg>
                        </span>
                        <span>
                          Настройки
                    ...
                    <li class="profile-menu-item bookmark-item">
                      <a href="#" class="profile-menu-link grey2 hover-black">
                        <span class="ico">
                          <svg width="24" height="24" viewBox="0 0 24 24">
                            <path class="svg-fill" d="M5 4H18V20L11.5 16.8L5 20V4Z" stroke-width="2"></path>
                          </svg>
                        </span>
                        <span>
                          Закладки
                      ...
                      <a href="#" class="profile-menu-link grey hover-grey2">
                        <span class="ico">
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path class="svg-stroke" d="M6 6V3H19V20H6V17" stroke="black" stroke-width="2" id="exitOutline"></path>
                            <path class="svg-fill" fill-rule="evenodd" clip-rule="evenodd" d="M15.3476 10.8072L12.0776 7L10.72 8.4417L12.4748 10.4848L5 10.5V12.5194H12.4972L10.72 14.5583L12.0777 16L16 11.5L15.3476 10.8072Z" fill="black"></path>
                          </svg>
                        </span>
                        <span>
                          Выйти из профиля
